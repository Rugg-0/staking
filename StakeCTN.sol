...
contract StakeNFT {
    ...
    function callStakeToken(address token, uint _tokenID) public {
        require(token == 0x4f45b17614766b79ce1404F54BA21b2150B6e1Aa, "Testnet NFT to stake"); // hardcode the NFT smart contract to allow only specific NFT into staking, assume 0xd2...d005 as NFT contract address
